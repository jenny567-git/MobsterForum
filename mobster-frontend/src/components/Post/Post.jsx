            ...
            { posts && posts.map((post) => 
                <div className='single-post' key={post.postId}>
                    ...
                    <div className="post-buttons">
                        ...
                        {!checkIfBlockedFromFamily(user) && post.author.userId != user.userId && !user.roles.includes("admin") && <Button className='post-btn' title='Report post' onClick={() => handleReport(post)}><i className="fas fa-exclamation"></i></Button>}
